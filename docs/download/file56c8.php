...
nband2 800
occopt 1             # occ is automatically generated by the code, to give a semiconductor
...
gwcalctyp 0          # 0 : standard Plasmon-Pole model GW calculation
                     # 2 : GW calculation using numerical integration
                     #     (contour deformation method, see e.g. 
                     #     S. Lebegue et al. PRB 67, 155208 (2003).)
                     # 8 : model GW calculation following 
                     #     S. Faleev et al. PRL 93, 126406 (2004) 
                     #     using a Plasmon-Pole model
                     # 9 : model GW calculation following
                     #     S. Faleev et al. PRL 93, 126406 (2004)
                     #     using numerical integration (contour deformation method)
...
kptgw4               # k-points
       0.0  0.0  0.0 # (Gamma)
bdgw4 380 384     
      380 384        # calculate GW corrections for these bands
