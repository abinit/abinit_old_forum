...
configure: ABINIT version 6.11.2
configure: M4 010416 - Autoconf 026800 - Automake 011101 - Libtool 000000
...
checking for Fortran libraries of gfortran...  -L/sw/lib -L/sw/lib/gcc4.4/lib/gcc/i386-apple-darwin10.4.0/4.4.4 -L/sw/lib/gcc4.4/lib/gcc/i386-apple-darwin10.4.0/4.4.4/../../.. -lgfortranbegin -lgfortran
...
checking for Python CPPFLAGS... -I/sw/include/python2.7 -I/sw/lib/python2.7/site-packages/numpy/core/include
checking for bzr... bzr
checking for Python NumPy headers... not found
checking numarray/arrayobject.h usability... no
checking numarray/arrayobject.h presence... yes
configure: WARNING: numarray/arrayobject.h: present but cannot be compiled
configure: WARNING: numarray/arrayobject.h:     check for missing prerequisite headers?
configure: WARNING: numarray/arrayobject.h: see the Autoconf documentation
configure: WARNING: numarray/arrayobject.h:     section "Present But Cannot Be Compiled"
configure: WARNING: numarray/arrayobject.h: proceeding with the compiler's result
configure: WARNING:     ## ------------------------------------------------- ##
...
checking for the requested DFT support... atompaw+wannier90
...
checking for the actual DFT support... atompaw-fallback+wannier90-fallback
configure: fallbacks to enable => atompaw etsf_io netcdf wannier90
...
configure: using tarball repository /Users/aldoromero/.abinit/tarballs
...
=== configuring in fallbacks (/Users/aldoromero/Abinit/6.11.2-private/fallbacks)
configure: running /bin/sh ./configure --disable-option-checking '--prefix=/usr/local'  'with_dft_flavor=atompaw+wannier90' 'CFLAGS=-I/sw/include' 'LDFLAGS=-L/sw/lib' 'CPPFLAGS=-I/sw/include' 'CXXFLAGS=-I/sw/include' '--enable-gui-build=yes' '--enable-atompaw=yes' '--enable-bigdft=no' '--enable-etsf-io=yes' '--enable-fox=no' '--enable-libxc=no' '--enable-linalg=no' '--enable-netcdf=yes' '--enable-wannier90=yes' '--with-fc-vendor=gnu' '--with-fc-version=4.4' '--with-tardir=/Users/aldoromero/.abinit/tarballs' --cache-file=/dev/null --srcdir=.
checking build system type... i386-apple-darwin10.8.0
checking host system type... i386-apple-darwin10.8.0
checking target system type... i386-apple-darwin10.8.0
checking for a BSD-compatible install... /usr/bin/install -c
...
checking for egrep... /usr/bin/grep -E
configure: fixing wrong path to mkdir replacement
./configure: line 3156: /config/gnu/install-sh: No such file or directory
configure: setting Fortran compiler vendor to gnu
configure: setting Fortran compiler version to 4.4
configure: setting tarball repository to /Users/aldoromero/.abinit/tarballs
...
configure: CPPFLAGS_NETCDF = -I/sw/include -DNDEBUG -DpgiFortran
configure: FCFLAGS_NETCDF  = -I/sw/include -DNDEBUG -DpgiFortran -g -O2
...
config.status: creating Makefile
config.status: executing depfiles commands
=== configuring in tests (/Users/aldoromero/Abinit/6.11.2-private/tests)
configure: running /bin/sh ./configure --disable-option-checking '--prefix=/usr/local'  'with_dft_flavor=atompaw+wannier90' 'CFLAGS=-I/sw/include' 'LDFLAGS=-L/sw/lib' 'CPPFLAGS=-I/sw/include' 'CXXFLAGS=-I/sw/include' '--enable-gui-build=yes' '--enable-atompaw=yes' '--enable-bigdft=no' '--enable-etsf-io=yes' '--enable-fox=no' '--enable-libxc=no' '--enable-linalg=no' '--enable-netcdf=yes' '--enable-wannier90=yes' '--with-fc-vendor=gnu' '--with-fc-version=4.4' '--with-tardir=/Users/aldoromero/.abinit/tarballs' --cache-file=/dev/null --srcdir=.
checking build system type... i386-apple-darwin10.8.0
checking host system type... i386-apple-darwin10.8.0
checking target system type... i386-apple-darwin10.8.0
...
Summary of important options:
  ...
  * DFT    flavor = atompaw-fallback+wannier90-fallback
