...
&                                     mpi_comm_rows, mpi_comm_cols, mpi_comm_all, useGPU)
...
!scalars
 ...
 integer,intent(in), optional :: mpi_comm_all
...
! *********************************************************************
 ...
 success=.true.
  ...
  success=solve_evp_real(na,nev,aa,lda,ev,qq,ldq,nblk,matrixCols,mpi_comm_rows,mpi_comm_cols,mpi_comm_all)
#else
...
#elif (defined HAVE_LINALG_ELPA_2016)
  success=solve_evp_complex(na,nev,aa,lda,ev,qq,ldq,matrixCols,nblk,mpi_comm_rows,mpi_comm_cols,mpi_comm_all)
#else
...
#elif (defined HAVE_LINALG_ELPA_2016)
 success = cholesky_real(na,aa,lda,nblk,matrixCols,mpi_comm_rows,mpi_comm_cols,.false.)
#else
...
#elif (defined HAVE_LINALG_ELPA_2016)
 success = elpa_cholesky_complex_double(na,aa,lda,nblk,matrixCols,mpi_comm_rows,mpi_comm_cols,.false.)
#else
...
#elif (defined HAVE_LINALG_ELPA_2016)
 success = invert_trm_real(na,aa,lda,nblk,matrixCols,mpi_comm_rows,mpi_comm_cols,.false.)
#else
...
#elif (defined HAVE_LINALG_ELPA_2016)
 success = invert_trm_complex(na,aa,lda,nblk,matrixCols,mpi_comm_rows,mpi_comm_cols,.false.)
#else
...
! *********************************************************************
   ...
   success =  mult_at_b_real(uplo_a,uplo_c,na,ncb,aa,lda,matrixCols, bb,ldb,matrixCols, nblk, &
...
! *********************************************************************
#if (defined HAVE_LINALG_ELPA_2016)
  success = mult_ah_b_complex(uplo_a,uplo_c,na,ncb,aa,lda,matrixCols, bb,ldb,matrixCols,nblk, &
&                    mpi_comm_rows,mpi_comm_cols,cc,ldc,matrixCols)
#else
