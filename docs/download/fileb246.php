...
# List of k-points for GW corrections.
    nkptgw   35    # number of kpts at which GW will be calculated
     kptgw         # List of kpts, must be corresponding to those used for the preparation of _WFK and _SCR 
      ...
      bdgw         # bands for which GW will be alculated
            1 27    # calculate GW corrections for bands 1 to 8 for each kpt
            1 27
            1 27
            1 27
            1 27
...
#Definition iof the unit cell
   acell  3*10.329641884   # From structural optimization with optcell1, iscf7 
