...
!!
!! COPYRIGHT
!! Copyright (C) 2004-2014 ABINIT group (JPC,MJV)
...
!etea
 integer,allocatable :: kphon2kfine(:)
 integer :: ikpt_phonv,ikpt_phonqv
 logical :: lkx,lky,lkz
! *************************************************************************
 ...
 ABI_ALLOCATE(elph_tr_ds%gamma_qpt_trin,(2,9,ib1,elph_ds%nsppol,ib2))
 ABI_CHECK_ALLOC('trying to allocate array elph_tr_ds%gamma_qpt_trin')
 elph_tr_ds%gamma_qpt_trin = zero

 ABI_ALLOCATE(elph_tr_ds%gamma_qpt_trout,(2,9,ib1,elph_ds%nsppol,ib2))
 ABI_CHECK_ALLOC('trying to allocate array elph_tr_ds%gamma_qpt_trout')
...
!etea
write(std_out,*)'DBG_ETEA : integrate_gamma_tr_lova.F90 -> elph_tr_ds%el_veloc'
ABI_ALLOCATE(kphon2kfine,(elph_ds%k_phon%nkpt))
ABI_CHECK_ALLOC('trying to allocate array kphon2kfine')
kphon: do ib1=1,elph_ds%k_phon%nkpt
kfine:   do ib2=1,elph_ds%k_fine%nkpt
    lkx = abs(elph_ds%k_phon%kpt(1,ib1)-elph_ds%k_fine%kpt(1,ib2)) < 1.0e-5
    lky = abs(elph_ds%k_phon%kpt(2,ib1)-elph_ds%k_fine%kpt(2,ib2)) < 1.0e-5
    lkz = abs(elph_ds%k_phon%kpt(3,ib1)-elph_ds%k_fine%kpt(3,ib2)) < 1.0e-5
  ...
  write(std_out,*)'kphon2kfine',ib1,'not found!!'
end do kphon
...
!etea
     ...
     ikpt_phonv= kphon2kfine(ikpt_phon)
...
!etea
     ...
     ikpt_phonqv= kphon2kfine(ikpt_phonq)
...
!         elvelock(:)=elph_tr_ds%el_veloc(ikpt_phon,fib1,:,isppol)
          elvelock(:)=elph_tr_ds%el_veloc(ikpt_phonv,fib1,:,isppol)
...
!           elvelockpq(:)= elph_tr_ds%el_veloc(ikpt_phonq,fib2,:,isppol)
            elvelockpq(:)= elph_tr_ds%el_veloc(ikpt_phonqv,fib2,:,isppol)
