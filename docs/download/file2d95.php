...
# Part-5: scqpgw  
  ...
  optdriver   8     # drive sigma calculation
     irdscr   1
  gwcalctyp   20    # scqpgw calculation with the standard plasmon-pole approximation.
  gw_sctype   4
gw_toldfeig   0.1 eV  # scqpgw stops when this tolerance is met
   gw_nstep   30    # max number of scqpgw cycles 
   ...
   ecutsigx   12    # Cutoff in the exchange part.
     ppmfrq   16.7 eV  #  the imaginary frequency where the dielectric matrix is evaluate
      nband   64    # Number of bands for the correlation part.
   icutcoul   6     # use coulomb cut-off to speed up convergence
